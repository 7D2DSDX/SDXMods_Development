...
public class GameObjectAnimalAnimationSDX : MonoBehaviour, IAvatarController
{
    ...
    void Awake()
    {
        ...
        try
        {
            ...
            Debug.Log("Searching for graphics");

            this.GraphicsTransform = this.transform.Find("Graphics");
			
			if ( this.GraphicsTransform == null )
				Debug.Log(" !! Graphics Transform null!" );
            Debug.Log("Searching for Model");
            ...
            Debug.Log("Searching for Idle");

			if ( this.ModelTransform.GetComponent<Animation>() == null )
				Debug.Log("No Animation for this model!" );
        ...
        {
            Debug.Log("Exception thrown in Awake() " + ex.ToString());
        }
    }
